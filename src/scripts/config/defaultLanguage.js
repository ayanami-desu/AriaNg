(function () {
    ...
    angular.module('ariaNg').config(['$translateProvider', 'ariaNgConstants', function ($translateProvider, ariaNgConstants) {
        var defaultLanguageResource = {
            ...
            'Root Path': 'Root Path',
            'Rclone Remote': 'Rclone Remote',
            'Rclone Config Path': 'Rclone Config Path',
            'Leave blank to keep the stored token.': 'Leave blank to keep the stored token.',
            'Proxy': 'Proxy',
            'Use Proxy': 'Use Proxy',
            'Proxy URL': 'Proxy URL',
            'Supported proxy protocols: HTTP, HTTPS, and SOCKS5.': 'Supported proxy protocols: HTTP, HTTPS, and SOCKS5.',
            'Leave blank to keep the stored proxy credentials.': 'Leave blank to keep the stored proxy credentials.',
            'No transfer destinations configured.': 'No transfer destinations configured.',
            'Failed to load transfer destinations.': 'Failed to load transfer destinations.',
            'Failed to save transfer destination.': 'Failed to save transfer destination.',
            'Failed to set default destination.': 'Failed to set default destination.',
            'Failed to delete transfer destination.': 'Failed to delete transfer destination.',
            'Delete this transfer destination?': 'Delete this transfer destination?',
            ...
            'Failed': 'Failed',
            'No gateway tasks found.': 'No gateway tasks found.',
            'Gateway is disabled.': 'Gateway is disabled.',
            'Failed to load gateway tasks.': 'Failed to load gateway tasks.',
            'Failed to retry gateway tasks.': 'Failed to retry gateway tasks.',
            'Are you sure you want to retry the selected gateway tasks?': 'Are you sure you want to retry the selected gateway tasks?',
            '{successCount} gateway tasks have been retried and {failedCount} tasks failed.': '{{successCount}} gateway tasks have been retried and {{failedCount}} tasks failed.',
            'Retry Mode': 'Retry Mode',
            'Retry Upload Only': 'Retry Upload Only',
            'Full Chain Retry': 'Full Chain Retry',
            'Full Chain Retry will cancel and delete the current task before starting a new download. Continue?': 'Full Chain Retry will cancel and delete the current task before starting a new download. Continue?',
            'Retry upload for the selected tasks? The download directory must exist.': 'Retry upload for the selected tasks? The download directory must exist.',
            'Delete Selected Tasks': 'Delete Selected Tasks',
            'Delete': 'Delete',
            'Confirm Delete': 'Confirm Delete',
            'Delete selected gateway tasks? This will cancel aria2 and remove downloaded data.': 'Delete selected gateway tasks? This will cancel aria2 and remove downloaded data.',
            'Failed to delete gateway tasks.': 'Failed to delete gateway tasks.',
            '{deletedCount} gateway tasks deleted and {failedCount} tasks failed.': '{{deletedCount}} gateway tasks deleted and {{failedCount}} tasks failed.',
            'File Name': 'File Name',
            'File Size': 'File Size',
            'Progress': 'Progress',
            ...
            'Transfer Gateway Token': 'Transfer Gateway Token',
            'Transfer Gateway Enabled': 'Transfer Gateway Enabled',
            'Transfer Gateway Protocol': 'Transfer Gateway Protocol',
            'Transfer Gateway Host': 'Transfer Gateway Host',
            'Transfer Gateway Port': 'Transfer Gateway Port',
            'Transfer Gateway Base Path': 'Transfer Gateway Base Path',
            'Activate': 'Activate',
